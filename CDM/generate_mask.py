...
if __name__ == "__main__":
    ...
    model.embedding_manager.load('coAno_108_small/mask-checkpoints/%s-%s/checkpoints/embeddings.pt'%(sample_name,anomaly_name))
    ...
    save_dir='1coAno_generated_mask/%s/%s'%(sample_name,anomaly_name)
