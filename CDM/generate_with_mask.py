...
from ldm.data.personalized_1 import Positive_sample_with_generated_mask
import random
...
if __name__ == "__main__":
    ...
    ckpt = torch.load('coAno_108_small/anomaly-checkpoints/checkpoints/spatial_encoder.pt')
    model.embedding_manager.spatial_encoder_model.load_state_dict(ckpt)
    model.embedding_manager.load('coAno_108_small/anomaly-checkpoints/checkpoints/embeddings.pt')
    ...
    save_dir = '1generated_dataset_1015/%s/%s' % (sample_name, anomaly_name)
